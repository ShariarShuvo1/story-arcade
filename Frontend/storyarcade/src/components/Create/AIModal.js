        ...
        >
            ...
            >
                ...
                <div className="my-4 flex gap-4">
                    <button
                        className={`rounded-lg font-bold bg-button-primary p-2 text-xl ${selectedMode === "image" ? "border-2 border-green-500 flex-grow" : "border-none hover:bg-button-hover_primary"}`}
                        onClick={(e)=> {setSelectedMode("image")}}
                    >
                        Image
                    </button>

                    <button
                        className={`rounded-lg font-bold bg-button-primary p-2 text-xl ${selectedMode === "gif" ? "border-2 border-green-500 flex-grow" : "border-none hover:bg-button-hover_primary"}`}
                        onClick={(e)=> {setSelectedMode("gif")}}
                    >
                        GIF
                    </button>
                </div>
                ...
                <div className="mt-2 text-text-light">
                    <div>
                        ...
                        />
                        Required Points:{" "}
                        <span className="text-text-muted">{selectedMode === "image" ? "1" : "2"}</span>
                    </div>
                    <div>
                        <img
                            alt="Ai Genaration Icon"
